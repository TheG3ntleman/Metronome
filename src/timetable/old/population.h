...
typedef struct {
	...
	uint n_organisms; // number of organisms
	uint n_sessions;
...
// Setters
void setVenueForSession(Population *population, uint tt_id, uint session_id, uint venue_id);
void setTimeSlotForSession(Population *population, uint tt_id, uint session_id, uint timeslot_id);
