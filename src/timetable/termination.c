...
char terminationCondition(uint generation_number, uint population_size, GeneticSpecifications *gaSpecs) {//numeric *delta_soft_fitness, numeric *delta_hard_fitness, GeneticSpecifications *gaSpecs) {
